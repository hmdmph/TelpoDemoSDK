...
public class PsamActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if((SystemUtil.getDeviceType() == StringUtil.DeviceModelEnum.TPS510.ordinal()) ||
				SystemUtil.getDeviceType() == StringUtil.DeviceModelEnum.TPS510A.ordinal() ||
				SystemUtil.getDeviceType() == StringUtil.DeviceModelEnum.TPS510A_NHW.ordinal() ||
